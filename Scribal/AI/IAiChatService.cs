...
public interface IAiChatService
{
    ...
    /// </summary>
    /// <param name="request">
    ///     A request encapsulating the user's input, the conversation ID, and the service ID of the model to
    ///     use.
    /// </param>
    /// <param name="history">
    ///     Optionally, a prepared chat history for the assistant to use.
    ///     If not provided, one will be created with a default system prompt for fiction-writing.
    /// </param>
