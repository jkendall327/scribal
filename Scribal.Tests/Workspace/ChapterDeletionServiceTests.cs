...
namespace Scribal.Tests.Workspace
{
    public class ChapterDeletionServiceTests
    {
        ...
        public async Task DeleteChapterAsync_ChapterDirectoryNotFound_StillSucceedsAndWarns()
        {
            ...
            _fileSystem.AddFile(TestPlotOutlineFile, new MockFileData(ToJson(initialOutline)));
            _fileSystem.AddFile(TestWorkspaceStateFile, new MockFileData(ToJson(initialState)));
